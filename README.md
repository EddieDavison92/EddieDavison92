I build the data platform at NHS West & North London ICB: dbt on Snowflake, primary care
records (OLIDS) and clinical terminology. Outside work I build free tools on NHS and UK public data.
...
- [snomed-ecl-engine](https://github.com/EddieDavison92/snomed-ecl-engine): run SNOMED CT ECL locally with no terminology server (Rust library, CLI, npm)
